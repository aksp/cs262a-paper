...
\draw[color=olive,thick] node[anchor=west] at (1.1,250) {\small PostgreSQL Python Django};
\draw[color=teal,thick] node[anchor=west] at (1.1,230) {\small PostgreSQL Python only};
\draw[color=green,thick] node[anchor=west] at (1.1,210) {\small MongoDB Python only};
\draw[color=red,thick] node[anchor=west] at (1.1,190) {\small MongoDB Meteor only};
\draw[color=blue,thick] node[anchor=west] at (1.1,170) {\small MongoDB Meteor PeerDB};
...
\draw[color=blue,thick] node[anchor=west] at (1.1,6200) {\small MongoDB Meteor PeerDB};
\draw[color=olive,thick] node[anchor=west] at (1.1,5900) {\small PostgreSQL Python Django};
\draw[color=teal,thick] node[anchor=west] at (1.1,5600) {\small PostgreSQL Python only};
\draw[color=green,thick] node[anchor=west] at (1.1,5300) {\small MongoDB Python only};
%\draw[color=brown,thick] node[anchor=west] at (1.1,2200) {\small MongoDB Python PeerDB};
...
\draw[color=red,thick] node[anchor=west] at (1.1,1000) {\small MongoDB Meteor PeerDB};
%\draw[color=blue,thick] node[anchor=west] at (1.1,900) {\small MongoDB Python PeerDB};

\draw[->] (1,0) -- coordinate (x axis) (5.2,0);
\draw[->] (1,0) -- coordinate (y axis) (1,1100);
\foreach \x in {1,2,...,5}
	\draw (\x,0pt) -- (\x,-3pt) node[anchor=north] {%
		\pgfkeys{/pgf/fpu=true}%
		\pgfmathparse{pow(10,\x)}%
