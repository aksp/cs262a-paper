...
\end{tikzpicture}%
\caption{Read time vs. number of documents. Number of documents is shown as a multiplier of basic numbers shown in table \ref{numbers}.}%
\label{number-read}%
\end{figure}
...
\end{tikzpicture}%
\caption{Write time vs. number of documents. Number of documents is shown as a multiplier of basic numbers shown in table \ref{numbers}.}%
\label{number-write}%
\end{figure}
...
\end{tikzpicture}%
\caption{Convergence time vs. number of documents. Number of documents is shown as a multiplier of basic numbers shown in table \ref{numbers}.}%
...
\draw[color=olive,thick] node[anchor=west] at (1.2,250) {\small PostgreSQL Python Django};
\draw[color=teal,thick] node[anchor=west] at (1.2,230) {\small PostgreSQL Python only};
\draw[color=green,thick] node[anchor=west] at (1.2,210) {\small MongoDB Python only};
\draw[color=red,thick] node[anchor=west] at (1.2,190) {\small MongoDB Meteor only};
\draw[color=blue,thick] node[anchor=west] at (1.2,170) {\small MongoDB Meteor PeerDB};
%\draw[color=brown,thick] node[anchor=west] at (1.2,2200) {\small MongoDB Python PeerDB};
...
\end{tikzpicture}%
\caption{Read time vs. size of embedded fields. Size is shown in bytes.}%
\label{size-read}%
\end{figure}
...
\draw[color=red,thick] node[anchor=west] at (1.2,6500) {\small MongoDB Meteor only};
\draw[color=blue,thick] node[anchor=west] at (1.2,6200) {\small MongoDB Meteor PeerDB};
\draw[color=olive,thick] node[anchor=west] at (1.2,5900) {\small PostgreSQL Python Django};
\draw[color=teal,thick] node[anchor=west] at (1.2,5600) {\small PostgreSQL Python only};
\draw[color=green,thick] node[anchor=west] at (1.2,5300) {\small MongoDB Python only};
%\draw[color=brown,thick] node[anchor=west] at (1.2,2200) {\small MongoDB Python PeerDB};
...
\end{tikzpicture}%
\caption{Write time vs. size of embedded fields. Size is shown in bytes.}%
\label{size-write}%
\end{figure}
...
\draw[color=red,thick] node[anchor=west] at (1.2,1000) {\small MongoDB Meteor PeerDB};
%\draw[color=blue,thick] node[anchor=west] at (1.2,900) {\small MongoDB Python PeerDB};
